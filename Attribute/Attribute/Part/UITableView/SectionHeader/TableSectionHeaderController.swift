...
extension TableSectionHeaderCourseCellDataSource {
    // MARK: - section
...
protocol ITableSectionHeaderController {
    /// row1_1:
...
extension TableSectionHeaderController: ITableSectionHeaderController {
    /// row1_1:
...
internal final class TableSectionHeaderController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationItem.title = TableHomeCourseCellDataSource.rowHeaderInSection
