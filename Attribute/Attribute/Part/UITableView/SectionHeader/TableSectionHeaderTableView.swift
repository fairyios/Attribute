...
protocol ITableSectionHeaderTableView {
...
internal final class TableSectionHeaderTableView: UITableView {
    
    var data: ITableSectionHeaderTableView! = nil
    ...
    init(target: UIViewController, data: ITableSectionHeaderTableView) {
...
extension TableSectionHeaderTableView: UITableViewDataSource {
...
extension TableSectionHeaderTableView: UITableViewDelegate {
